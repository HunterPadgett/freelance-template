        ...
        <div className="container">
          <form target="_blank" action="https://formsubmit.co/676eb6ebd07f887811064705af76dfc2" method="POST">
            <div className="form-group" id="contactForm">
              <div className="form">
                <div className="pb-3 col-lg-4 col-md-8 col-sm-12 mx-auto ">
                ...
                <div className="form-group pb-3 text-center w- mx-auto">
                  ...
                  <button type="submit" className="btn col-md-3 col-sm-10 border border-transparent mx-auto btn-lg subbtn btn-block hover:bg-blue-900 text-white mt-3">Submit Form</button>
                </div>
              </div>
            </div>
          </form>
