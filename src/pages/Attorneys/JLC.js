   ...
   <div className="container bg-gray-50 scrollable">
    <div className="grid grid-cols-1 text-center">
     ...
     <div className="m-2">
      ...
      <hr class=" mx-auto w-36 m:w-48 h-0.5 bg-gray-900 rounded border-0  dark:bg-gray-900"></hr>
      <ul className="md:text-lg">
       <li className="m-1">Admitted to the State Bar of Georgia in 1988</li>
       <li className="m-1">Chairman of Chatham County Board of Elections</li>
       <li className="m-1">
        Admitted to practice in the U.S. Supreme Court, U.S. Court of Appeals
        4th and 11th Circuits, and the U.S. District Courts for the Southern
        District of GA & SC
       </li>
       <li className="m-1">
        Admitted to practice in the GA Supreme Court & GA Court of Appeals
       </li>
       <li className="m-1">
        Admitted to practice in the SC Supreme Court & SC Court of Appeals
       </li>
       <li className="m-1">
        Special Assistant Attorney General (SAAG) Georgia Ports Authority 1987 –
        Present
       </li>
       <li className="m-1">
       ...
       <li className="m-1">General Counsel, Benedictine Military School</li>
       <li className="m-1">
