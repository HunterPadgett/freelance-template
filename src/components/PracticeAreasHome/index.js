    ...
    <div className="grid flex items-center grid-cols-1">
      <div class="container text-center mt-5">
        ...
        <p className="mb-3 text-lg">
          ...
          knowledge for eight decades. Providing top corporations in the area as
          well as individuals with sound advice, iron clad negotiations, and
          anticipated results; MAHONEY COLE & COURSEY is the choice for your
          legal needs in Georgia and South Carolina.
        </p>
        <p className="mb-3 text-lg">
          ...
          for three generations. Whether you are starting a business, closing on
          a real estate property or home, working on your Estate Plan, or need
          legal help in Court – our lawyers provide exemplary legal solutions
      ...
      <div className="mt-3 mb-3  flex-row text-lg container">
      ...
      <button className="mb-5 mt-2 border-none flex flex-row items-center justify-center">
        <a
          href="/practice-areas"
          className="flex border-none flex-row w-1/2 justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg md:w1/4 lg:w-1/5"
        >
