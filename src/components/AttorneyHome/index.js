  ...
  <div className="grid flex items-center grid-cols-1 shadow-xl  max-w-fit border-0 attorneyhome">
   <div class="container text-center mt-5">
    ...
    <p className="mb-3 text-lg text-white ">
     To deliver consistent results, we find that it is crucial to maintain the
     bonds of trust between attorney and client. We are part of the community,
     we will continue to be part of the community, and our integrity and duty to
     our clients shows this commitment.
    </p>
    <p className="mb-3 text-lg text-white">
     We support local initiatives. We act as General Counsel for State and Local
     business and local academic institutions. We are Judges for city and county
     municipalities. We are privileged to be designated as SAAG (State Appointed
     Attorney General) and have served as City and County Attorney.
    </p>
    <p className="text-lg text-white">
     We know the pulse of Savannah and the interworking of our local and state
     government. SMITH JONES & GREENBURG is well-respected for our history of
     excellence and because of the intense knowledge brought to every client we
     serve and to each case we win.
    </p>
   </div>
      ...
      <Link to="TJM">
       <div class="rounded-lg shadow-lg bg-white max-w-sm border-0">
        ...
        <div class="card-body text-center  ">
         <h6 class="card-title mb-0">Thomas J. Smith III</h6>
     ...
     <div class="col-xl-4 col-md-6 mb-4">
      <Link to="JHC">
       <div class="rounded-lg shadow-lg bg-white max-w-sm border-0">
        ...
        ></img>
        <div class="card-body text-center ">
         <h6 class="card-title mb-0">James H. Greenburg</h6>
     ...
     <div class="col-xl-4 col-md-6 mb-4">
      <Link to="BDS">
       <div class="rounded-lg shadow-lg bg-white max-w-sm border-0">
        ...
        ></img>
        <div class="card-body text-center  ">
         <h6 class="card-title mb-0">Benjamin D. Butters</h6>
