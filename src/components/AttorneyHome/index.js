...
const AttorneyHome = () => {
  return (
    <div className="grid flex items-center grid-cols-1">
      ...
      <button className="mb-2 mt-2 flex flex-row items-center justify-center">
        <a
          href="/Attorneys"
          className="flex flex-row w-1/2 justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg md:w1/5 lg:w-1/6"
        >
          Meet Our Team
        </a>
      </button>
